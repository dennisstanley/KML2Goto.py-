...
unit_num = input('Glider Unit #  [000] : ')
unit_num = unit_num or '000'
...
print ("saving file to {}goto_l40.ma".format(savepath))

GotoFile = open(savepath+"goto_l40.ma", "w")



GotoFile.write("behavior_name=goto_list \n")
GotoFile.write("#============================================================ \n")
GotoFile.write("# --- goto_l40.ma             ---\n")
GotoFile.write("# Generated for Unit{} by KML2Goto.py from {} at {} \n".format(unit_num,source_kml,datetime.now().strftime("%b %d %Y %H:%M:%S")))   
